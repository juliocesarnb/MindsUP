  ...
  const accordionData = [
    {
      ...
      description: "Por meio dos simulados e análises socioemocionais a equipe da sua escola terá uma visão integral e completa dos estudantes, possibilitando inúmeras opções de planos personalizados de intervenções pedagógicas.",
      imageUrl: "./assets/images/text1-accordion.svg",
    },
    {
      title: "Abandone práticas que não funcionam",
      description: "Por meio da nossa plataforma integrada e com o suporte da nossa equipe de dados,  a escola poderá observar quais práticas realmente funcionam e para quais estudantes, focando em intervenções que são realmente efetivas para os resultados dos estudantes.",
      imageUrl: "./assets/images/text2-accordion.svg",
    },
    {
      title: "Comunique além do boletim",
      description: "Nossas devolutivas para pais e estudantes utilizam ferramentas personalizadas de ciência comportamental, possibilitando maior engajamento de pais e estudantes.",
      imageUrl: "./assets/images/text3-accordion.svg",
    },
    {
      title: "Use dados de forma humanizada",
      description: "Abandone a visualização dos seus estudantes apenas pelo número de questões certas ou erradas que eles responderam no último simulado. Tenha uma visão integral, completa e multidimensional do estudantes. Adote Mind's Up na sua escola e vá além!",
      imageUrl: "./assets/images/text4-accordion.svg",
    },
  ];

  return (
    <section id="secao2" className="min-h-screen bg-purple-1 rounded-xl m-3">
      <div className="grid grid-cols-12 gap-4 lg:gap-8">
        <div className="col-span-12 lg:w-[36rem] min-h-screen z-10 bg-purple-1 lg:col-span-5 lg:col-start-1 pt-28 lg:rounded-r-3xl">
          <div className="divide-y w-[98%] divide-slate-700/20">
            {accordionData.map((item, index) => (
              <div
                key={index}
                className={`relative py-4 rounded-lg ${
                  activeIndex === index ? "bg-purple-200" : "hover:bg-purple-100"
                }`}
              >
                <h3
